...
public class Program {
    ...
    public static void main(String[] args) {
        ...
        while (f) {
            ...
            System.out.println("8. Вызвать метод deleteModel с указанным индексом модели, которую необходимо удалить");
                ...
                try {
                    switch (no) {
                        ...
                        case 7:
                            ...
                            break;
                        case 8:
                            System.out.print("Укажите индекс модели: ");
                            if (scanner.hasNextInt()) {
                                int modelIndexToDelete = scanner.nextInt();
                                scanner.nextLine();
                                editor3D.deleteModel(modelIndexToDelete);
                            } else {
                                System.out.println("Номер модели указан некорректно.");
                            }
                            break;
